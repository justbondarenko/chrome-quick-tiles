...
<template>
  ...
  <div
    v-else
    class="w-3/5 h-fit mt-12 mx-auto py-12 px-16 flex flex-col border-2 rounded-2xl border-dashed prose prose-md prose-slate items-center justify-center opacity-50"
  >
    ...
    <span class="prose-sm">
      * Only individual bookmarks from selected folder will be imported. Child folders
