<template>
  <div class="flex flex-col gap-2 w-full">
    ...
    <div class="flex flex-col w-100">
      ...
      <input type="text" placeholder="Any CSS color" class="input input-bordered w-full" v-model="innerBgColor"
        :disabled="!innerUrl" />
    </div>
    <div class="flex flex-col w-100">
      <div class="label">
      ...
      <input type="text" placeholder="Any CSS color" class="input input-bordered w-full"
        v-model="innerFontColor" :disabled="!innerUrl" />
    </div>
